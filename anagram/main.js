(this.wordle = this.wordle || {}),
    (this.wordle.bundle = (function (e) {
        ...
        var Ha = new Date(2026, 4, 21, 0, 0, 0, 0); // ANAGRAM launch anchor — adjust before deploy
        function Na(e, a) {
            var s = new Date(e),
